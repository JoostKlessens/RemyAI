...
**Stand:** 4 september 2026, `feat/live-import-and-plan-phases`, t/m
`6158bc3` gepusht; **de wijzigingen van GAP-20 t/m GAP-23 staan in de
werkboom en zijn nog niet gecommit.** Voor die vijf regels betekent `✅`
hieronder dus "gebouwd en getest", nog niet "gepusht" — de enige plek in dit
document waar de legenda vooruitloopt op git.
